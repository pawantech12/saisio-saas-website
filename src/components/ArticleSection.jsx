    ...
    <section className="px-24 py-24">
      ...
      <div className="grid grid-cols-2 gap-5 mt-14">
        ...
        <div className="flex flex-col gap-5">
          <div className="border border-title rounded-xl shadow-[4px_4px_0_0] shadow-title flex ">
            <figure className="overflow-hidden rounded-s-xl w-1/2 h-full">
              <img
            ...
            <div className="px-5 py-8 space-y-5 w-1/2">
